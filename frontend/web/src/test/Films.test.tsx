...
//   render(
//     <Provider store={store}>
//     <MockedProvider mocks={[filmMock2]} addTypename={false}>
//       <Films  />
//     </MockedProvider>
//     </Provider>
//   );
//   expect(await screen.findByText("Loading...")).toBeInTheDocument();
//   expect(await screen.findByText("The Cat and the Canary")).toBeInTheDocument();
//   expect(await screen.queryByText("After Dark in Central Park")).not.toBeInTheDocument();
